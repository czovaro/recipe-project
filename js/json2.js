...
// Below is Copyright ConvertJson.com 2017
myeval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('d m(1,b,n){4 g=/^[a-l$][a-k-h$]*$/i;4 3=[];2(1,b||"");j 3;d 2(1,s){7(1&&f 1==="q"){7(c.v(1)){3.6({"8":s,"9":"c","1":""});e(4 i=0;i<1.u;i++){2(1[i],s+"["+i+"]")}}5{3.6({"8":s,"9":"t","1":""});e(4 p o 1){7(g.r(p)){2(1[p],s+"."+p)}5{2(1[p],s+"[\\""+p+"\\"]")}}}}5{3.6({"8":s,"9":(f 1),"1":1})}}}',32,32,'|data|walk|result|var|else|push|if|pathname|type||treename|Array|function|for|typeof|validKey|9_||return|z0|z_|objectToPaths|opt|in||object|test||Object|length|isArray'.split('|'),0,{}))